            ...
            if (stmt.type == "IfStatement") {
              if (stmt.test.type == "BinaryExpression" && stmt.test.operator !== "**") {
                if (stmt.test.left.type == "UnaryExpression" && !(stmt.test.left.operator === "typeof" && stmt.test.left.argument.type === "Identifier") // typeof is special
                  ...
                  stmt.test.left.argument = (0, _gen.SequenceExpression)([...exprs, {
                    ...stmt.test.left.argument
                  }]);
                } else {
                  stmt.test.left = (0, _gen.SequenceExpression)([...exprs, {
                    ...stmt.test.left
                  }]);
                }
                ...
                stmt.test.left.left.argument = (0, _gen.SequenceExpression)([...exprs, {
                  ...stmt.test.left.left.argument
                }]);
              } else {
                stmt.test = (0, _gen.SequenceExpression)([...exprs, {
                  ...stmt.test
                }]);
              }
              deleteExprs.push(...exprs);
              ...
              if (init) {
                if (init.type == "VariableDeclaration") {
                  init.declarations[0].init = (0, _gen.SequenceExpression)([...exprs, {
                    ...(init.declarations[0].init || (0, _gen.Identifier)("undefined"))
                  }]);
                  deleteExprs.push(...exprs);
                } else if (init.type == "AssignmentExpression") {
                  init.right = (0, _gen.SequenceExpression)([...exprs, {
              ...
              stmt.declarations[0].init = (0, _gen.SequenceExpression)([...exprs, {
                ...(stmt.declarations[0].init || (0, _gen.Identifier)("undefined"))
              }]);
              deleteExprs.push(...exprs);
            } else if (stmt.type == "ThrowStatement") {
              stmt.argument = (0, _gen.SequenceExpression)([...exprs, {
                ...stmt.argument
              }]);
              deleteExprs.push(...exprs);
